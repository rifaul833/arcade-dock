...
BreakLock is a hybrid of Mastermind and the Android pattern lock. A game you're gonna love to hate.
...
The goal of this project was to discover progressive Web apps with service workers, and play with Webpack. Also to entertain because the tube is quite boring, especially on the Central line on peak time.
...
Contributions are welcome, especially pull-requests. There are a lot of ideas to implement, but less people when it comes to code. This is why **issues are for bugs only**.
...
- Add your locale in this files:
  - `index.html`
  - `src/controllers/langselector/langselector.ctrl.js`
- Open a pull request.
